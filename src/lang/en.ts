export const languageEnglish = {
    ...
    importFromSpicyChat: "Choose from SpicyChat",
    importFromSpicyChatDesc: "Browse and import characters from SpicyChat",
    spicyChat: {
        search: "Search",
        sortPopular: "Popular",
        ...
        madeBy: "Made by {}",
        alreadyImported: "This character is already imported from SpicyChat. Open the existing character instead?",
        definitionHidden: "The creator of this character has hidden its full definition. Only the greeting and basic info will be imported.",
        loadFailed: "Failed to load data from SpicyChat",
        configFailed: "Failed to connect to SpicyChat",
        rateLimited: "SpicyChat rate limit reached. Please wait a moment and try again.",
        login: "Login to SpicyChat",
        logout: "Logout from SpicyChat",
    },
    random: "Random",
    metaData: "Meta Data",
