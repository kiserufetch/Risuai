...
<textarea
    ...
    bind:value={value}
    class="rounded-lg p-2 text-textcolor bg-darkbg/40 resize-none overflow-y-hidden border border-darkborderc focus:border-primary-500 focus:ring-2 focus:ring-primary-500/25 focus:outline-hidden transition-colors duration-200 w-full message-edit-area"
