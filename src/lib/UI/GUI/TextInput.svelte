...
{#if hideText}
    ...
    <input 
        class={"border border-darkborderc peer focus:border-primary-500 rounded-lg shadow-xs text-textcolor bg-darkbg/40 focus:ring-primary-500/25 focus:ring-2 focus:outline-hidden placeholder:text-textcolor2/60 transition-colors duration-200" + ((className) ? (' ' + className) : '')} 
